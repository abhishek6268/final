        ...
        {selectedCategory == "Home" && (
          <div className="w-full h-screen">
            ...
            <div className="w-full h-[500px]">
              {/* flex heading */}
              <h2 className="mobile:text-xl text-4xl text-center my-6 capitalize text-primary font-semibold ">
                {flexheading}
              </h2>
              <div className="w-full h-[400px] flex items-center justify-around bg-yellow-100 mobile:px-4">
                <div className="flex mobile:flex-col mobile:h-auto items-center justify-around web:w-[80%] h-[300px] rounded-lg bg-primary text-secondary">
                  ...
                  <div className="web:px-12 web:py-2 flex flex-col mobile:items-center gap-1 mobile:py-4 ">
                    <h2 className="mobile:text-[18px] text-2xl text-secondary ">
                      A tastefull tale of flavour and quality
                    </h2>
                    <p className="mobile:text-[12px] mobile:text-center">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Ut accusamus beatae animi consequuntur distinctio corrupti
                      tempore neque quam. Autem aut architecto recusandae
                      eveniet repudiandae reiciendis ab, possimus et dolorem
                      magni.
                    </p>
                    {/* explre btn */}
