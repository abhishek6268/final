    ...
    <div className="">
      <section className="py-4 relative ">
        <div class=" dark:bg-gray-800 py-8 ">
          <div class="max-w-7xl  mx-auto sm:px-6 lg:px-8 p-20 border rounded-2xl   shadow-md">
            <div class="flex flex-col md:flex-row -mx-4">
              <div class="md:flex-1 px-4">
                <div class="h-[420px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                  <img
              ...
              <div class="md:flex-1 px-4">
                ...
                <div className="block w-full mb-6">
                  ...
                  <div class="flex justify-between w-1/2 ">
                    <button
                      type="button"
                      class="py-3 px-4 inline-flex justify-center items-center gap-2 -ml-px first:rounded-l-lg first:ml-0 last:rounded-r-lg border font-medium bg-white text-gray-900 align-middle hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-primary transition-all text-sm "
                    >
                      {" "}
                      500gm{" "}
                    </button>
                ...
                <div>
                  ...
                  <div class="flex -mx-2 mt-6">
                    ...
                    <div class="w-1/2 px-2" onClick={handleitem}>
                      <button class="w-full bg-primary dark:bg-gray-700 text-white dark:text-white py-2 px-4 rounded-full font-bold  ">
                        Add to Cart
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-12 h-full px-8 max-lg:py-8 rounded-3xl bg-gray-100 w-full max-xl:max-w-3xl max-xl:mx-auto">
                    ...
                    <div className="col-span-12 md:col-span-4 max-lg:mt-8 md:pl-8">
                      <div className="flex items-center flex-col justify-center w-full h-full ">
                        <button className="rounded-full px-6 py-4 bg-primary font-semibold text-lg text-white whitespace-nowrap mb-6 w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                          Write A Review
                        </button>
                        <button className="rounded-full px-6 py-4 bg-white font-semibold text-lg text-primary whitespace-nowrap w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100 hover:shadow-indigo-200">
                          See All Reviews
                        </button>
                      </div>
                    </div>
