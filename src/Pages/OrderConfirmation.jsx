        ...
        <div className="">
            <section class="py-24 relative">
                <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                    ...
                    <h6 class="font-medium text-xl leading-8 text-black mb-3">Hello, Christine</h6>
                    ...
                    <div class="grid grid-cols-7 w-full pb-6 border-b border-gray-100">
                        <div class="col-span-7 min-[500px]:col-span-2 md:col-span-1">
                            <img src="https://pagedone.io/asset/uploads/1701167681.png" alt="Skin Care Kit image" class="w-full" />
                        </div>
                        <div
                            ...
                            <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center justify-between">
                                <div class="">
                                    <h5 class="font-manrope font-semibold text-2xl leading-9 text-black mb-6">Skin Care Kit
                                    </h5>
                    ...
                    <div class="grid grid-cols-7 w-full py-6 border-b border-gray-100">
                        <div class="col-span-7 min-[500px]:col-span-2 md:col-span-1">
                            <img src="https://pagedone.io/asset/uploads/1701167697.png" alt="Skin Tone Serum image" class="w-full" />
                        </div>
                        <div
                            class="col-span-7 min-[500px]:col-span-5 md:col-span-6 min-[500px]:pl-5 max-sm:mt-5 flex flex-col justify-center">
                            <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center justify-between">
                                <div class="">
                                    <h5 class="font-manrope font-semibold text-2xl leading-9 text-black mb-6">Skin Tone
                                        Serum
                                    </h5>
                                    <p class="font-normal text-xl leading-8 text-gray-500">Quantity : <span
                                        class="text-black font-semibold">1</span></p>
                    ...
                    <div class="flex items-center justify-center sm:justify-end w-full my-6">
                        <div class=" w-full">
                            ...
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <p class="font-semibold text-xl leading-8 text-gray-900">$60.00</p>
                            </div>
                            <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex items-center justify-between py-6 border-y border-gray-100">
                                ...
                                <p class="font-manrope font-bold text-2xl leading-9 text-indigo-600">$300.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="data ">
