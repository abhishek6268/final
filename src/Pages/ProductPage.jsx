    ...
    return (
        <div class="font-[sans-serif]">
            <div class="p-4 mx-auto lg:max-w-6xl max-w-xl md:max-w-full mt-4">
                <h2 class="text-4xl font-extrabold text-gray-800 mb-12">Cookie house</h2>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {
                        productsData.map((item) => {
                            return (
                                <div key={item.id} class="bg-secondary rounded-2xl p-6 cursor-pointer hover:-translate-y-2 transition-all relative">
                                    <div
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <button type="button"
                                            ...
                                            class="w-full flex items-center justify-center gap-3 mt-6 px-4 py-2.5 bg-primary hover:bg-secondary hover:text-primary text-secondary  border-2 font-semibold border-[#333] rounded-xl">
