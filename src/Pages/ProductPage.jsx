...
const ProductPage = () => {
    ...
    return (
        ...
        //                     return (
        //                         <div key={item.id} class="bg-gray-100 rounded-2xl p-6 cursor-pointer hover:-translate-y-2 transition-all relative">
        //                             <div
        ...
        //                                 <h4 class="text-2xl text-gray-800 font-bold mt-4">{item.discountPercentage} <strike
        //                                     class="text-gray-400 ml-2 font-medium">{item.price}</strike>
        //                                 </h4>
        //                                 <button type="button"
        //                               
        //                                     class="w-full flex items-center justify-center gap-3 mt-6 px-4 py-2.5 bg-white hover:bg-gray-200 hover:text-gray-700 text-gray-900  border-2 font-semibold border-[#333] rounded-xl">
                                ...
                                <section class="p-5 py-10 bg-green-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
                                    ...
                                    <div className="flex justify-around item-center">
                                        <div className=" flex justify-around item-center gap-2">
                                            <h2 class="font-semibold mb-5">${item.discountPercentage}</h2>
                                            <h2 class="font-semibold mb-5 line-through">${item.price}</h2>
                                        </div>
                                    </div>
