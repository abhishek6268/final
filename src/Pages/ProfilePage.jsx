...
const ProfilePage = () => {
    return (
        <section class="relative pt-40 pb-24 bg-gray-100">
            {/*  cover bg */}
            <img src={bg} alt="cover-image" class="w-full absolute top-0 left-0 z-0 h-60" />
            {/* profile section  */}
            <div class="w-full max-w-7xl mx-auto px-6 md:px-8 flex justify-around">
                <div class="flex flex-col items-center justify-center sm:justify-start relative z-10 mb-5">
                    <img src="https://pagedone.io/asset/uploads/1705471668.png" alt="user-avatar-image" class="border-4 border-solid border-white rounded-full" />
                    <div class="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5">
                        <div class="block">
                            <h3 class="font-manrope font-bold text-4xl text-gray-900 mb-1">Emma Smith</h3>
                    ...
                    <div class="flex items-center gap-4">
                        <button
                            ...
                            Profile</button>
                        <button
                            class="py-3.5 px-5 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-base leading-7 shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100">Settings</button>
                    </div>
