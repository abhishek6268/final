        ...
        <>
            <div class="py-6 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
                <div class="flex justify-start item-start space-y-2 flex-col">
                    <h1 class="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 text-center md:text-start lg:leading-9 text-gray-800">Order #13432</h1>
                    <p class="text-base dark:text-gray-300 font-medium leading-6 text-gray-600 text-center md:text-start">21st Mart 2021 at 10:34 PM</p>
                </div>
                ...
                <div class="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-6">
                    ...
                    <div className="md:flex gap-2">
                        ...
                        <div class="flex mt-4 w-full justify-center items-center md:justify-start md:items-start">
                            <button class="mt-6 md:mt-0 dark:border-white dark:hover:bg-gray-900 dark:bg-transparent dark:text-white py-5 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base font-medium leading-4 text-gray-800"><Link to={"/payment"} >Continue</Link></button>
                        </div>
                    </div>
                </div>
